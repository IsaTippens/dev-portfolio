<!--
	...
	A1–E1. Hovering the drawing plays a notification: every Glyph double-flashes, the
	camera ring first and the exclamation mark last.
-->
<svg
	viewBox="-2 -2 80.4 166.1"
	class="line-art relative block h-full w-full"
	role="img"
	aria-label="Line drawing of the back of the Nothing Phone (2) with its Glyph Interface"
>
	...
	<g>
		...
		/>
		<!-- E1 -->
		<rect class="glyph" style="--delay: 240ms" x="37" y="151.7" width="2.4" height="3.4" rx="1.2" />
	</g>
</svg>
